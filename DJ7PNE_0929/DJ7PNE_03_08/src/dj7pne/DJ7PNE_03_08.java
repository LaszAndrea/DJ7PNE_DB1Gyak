...
public class DJ7PNE_03_08 {

	private static DJ7PNE_03_08 adatok[];
	...
	public DJ7PNE_03_08(String aznosito, String nev) {
		this.aznosito = aznosito;
		this.nev = nev;
	}
	...
	public static DJ7PNE_03_08[] beker(DJ7PNE_03_08[] adatok, Scanner sc) throws IOException {
		...
		for (int i = 0; i < adatok.length; i++) {
			...
			adatok[i] = new DJ7PNE_03_08(azonosito, nev);
			ossz++;
	...
	public static void torles(DJ7PNE_03_08[] adatok, Scanner sc) throws IOException {
	...
	public static void modosit(DJ7PNE_03_08[] adatok,Scanner sc) throws IOException {
